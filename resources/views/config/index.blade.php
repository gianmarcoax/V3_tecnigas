    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                <div class="bg-indigo-600 text-white rounded-xl p-2">
                ...
                <div>
                    <h2 class="font-bold text-xl text-gray-900">Configuración del Sistema</h2>
                    <p class="text-sm text-gray-500">Gestión de usuarios y roles</p>
                </div>
            </div>
            <button onclick="openModal('modal-crear')"
                class="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-4 py-2 rounded-xl transition shadow-sm text-sm">
